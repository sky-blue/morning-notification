...
CLASSES = {
    (1, 1): {
        ...
        "timetable": {
            ...
            1: ["통합과학1", "미술", "공통국어1", "과학탐구실험1", "체육1", "한국사1", "통합사회1"],
            2: ["공통국어1", "공통영어1", "통합과학1", "공통수학1", "자율·자치활동", "자율·자치활동"],
            3: ["정보", "미술", "미술", "통합사회1", "진로활동", "공통수학1", "한국사1"],
    ...
    (1, 2): {
        ...
        "timetable": {
            ...
            2: ["과학탐구실험1", "공통영어1", "통합과학1", "공통수학1", "자율·자치활동", "자율·자치활동"],
    ...
    (1, 3): {
        ...
        "timetable": {
            ...
            2: ["통합과학1", "통합사회1", "공통수학1", "정보", "자율·자치활동", "자율·자치활동"],
    ...
    (1, 4): {
        ...
        "timetable": {
            ...
            1: ["공통국어1", "공통영어1", "정보", "통합사회1", "진로활동", "체육1", "공통수학1"],
            2: ["통합사회1", "통합과학1", "공통수학1", "공통국어1", "자율·자치활동", "자율·자치활동"],
    ...
    (1, 5): {
        ...
        "timetable": {
            ...
            1: ["통합과학1", "통합사회1", "음악", "음악", "공통수학1", "공통국어1", "정보"],
            2: ["공통국어1", "한국사1", "체육1", "공통영어1", "자율·자치활동", "자율·자치활동"],
    ...
    (1, 6): {
        ...
        "timetable": {
            ...
            1: ["한국사1", "통합사회1", "진로활동", "체육1", "공통수학1", "공통국어1", "과학탐구실험1"],
            2: ["통합과학1", "통합사회1", "한국사1", "공통영어1", "자율·자치활동", "자율·자치활동"],
